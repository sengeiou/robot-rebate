-- 创建mysql库
DROP DATABASE IF EXISTS `robot-rebate`;
create database `robot-rebate` default character set utf8mb4 collate utf8mb4_general_ci;
...
/*
 ...
 Source Schema         : robot-rebate-os-re
